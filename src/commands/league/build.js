...
module.exports = {
    data: new SlashCommandSubcommandBuilder()
        .setName('build')
        .setDescription('Muestra la build de un campeón')
    ...
    async execute(interaction) {
        ...
        captureAll([{
            ...
            if (!replied) return interaction.followUp({ embeds: [error('No he podido encontrar la build del campeón para la línea que me has pedido.', interaction.user.tag)] });
        }, 15000);
    }
};
