...
async function execute(interaction) {
    var champion = interaction.options.getString('champion');
...
const data = new SlashCommandSubcommandBuilder()
    ...
    .setDescription('Shows the most popular runes for a champion')
    .setDescriptionLocalizations({
        'es-ES': 'Muestra las runas más populares para un campeón'
    })
